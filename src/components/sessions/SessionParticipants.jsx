...
const SessionParticipants = ({ participants = [], host }) => {
        ...
        return (
          ...
          >
            <div className="flex items-center gap-3">
              <div className="w-9 h-9 rounded-full bg-cyan-50 border border-cyan-200 text-primary font-bold flex items-center justify-center">
